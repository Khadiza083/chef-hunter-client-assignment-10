        ...
        <div>
            ...
            <Container>
                <Pdf targetRef={ref} filename="blog.pdf">
                    {({ toPdf }) => <button onClick={toPdf}><FaDownload className='custom-color'>Generate Pdf</FaDownload></button>}
                </Pdf>
                <div ref={ref}>
                    <h1 className='text-center custom-color'>Welcome to blog page!!</h1>
